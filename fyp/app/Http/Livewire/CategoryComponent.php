...
class CategoryComponent extends Component
{
    ...
    {
        Cart::add($product_id,$product_name,1,$product_price)->associate('AppModelsProduct');
    ...
    {  
        ...
        return view('livewire.category-component',['products'=> $products,'categories'=>$categories,'category_name'=>$category_name])->layout("layouts.project");
    }
}