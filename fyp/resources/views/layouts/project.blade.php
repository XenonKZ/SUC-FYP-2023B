				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: 01121957354" href="{{route('contact')}}" ><span class="icon label-before fa fa-mobile"></span>Hotline: 01121957354</a>
								</li>
							</ul>
						</div>
		...
		@if(Auth::user()->utype === 'ADM')
			<li class="menu-item menu-item-has-children parent" >
				...
				<ul class="submenu curency" >
					...
					<li class="menu-item">
						<a title="Settings" href="{{route('admin.contact')}}">User contact</a>
					</li>
					<li class="menu-item">
...
@endif
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{asset('assets/images/knlogo.png')}}" class ="logo" alt="mercado"></a>
						</div>
	...
	<script src="https://cdn.tiny.cloud/1/y3gzppk2eqnq7ndc3zh14cadg8v0cv1nmrbxyof2sdb60kxf/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
	@livewireScripts
